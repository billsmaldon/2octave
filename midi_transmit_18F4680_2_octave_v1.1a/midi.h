...
#include <xc.h>
#include "main.h"
//#define _XTAL_FREQ 20000000 //in 'main.h'
...
#define delay_bytes 320     //NO SHORTER THAN 320 uS!


__bit CONTROL_CHANGE_IS_BEING_SENT;

unsigned char GLOBAL_STATUS_BYTE;
unsigned char GLOBAL_CC_NUMBER;
unsigned char GLOBAL_CC_VALUE;
