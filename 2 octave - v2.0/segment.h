...
//function prototypes
void display(void);         //function refreshes 7 segment display exactly once
                            //either set to "DIGITS" or "STRING"
void displayString(void);   //function to display an ASCII string (4 chars)
void displayDigits(void);   //function to display a signed int number (999 to -999)
...
#define digit_delay 5 //7 segment display delay per digit
...
const unsigned char seg_bcd_hex[]={0x3F, //Hex value to display the number 0
                    ...
                    0x71  //F
                      ...
                      //for CA, bitwise not before display

//7 segment display codes (ascii):
//for common anode display, bitwise NOT (~) character to display
