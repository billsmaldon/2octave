...
#define coarse_fine_delay_ms 500        //in milliseconds
unsigned long number_of_interrupts;     //in TIMER2 interrupts (2.5 mS)
unsigned long count_ISR;                //count TIMER2 interrupts
