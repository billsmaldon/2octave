...
//function prototype to un-block code while in MENU
void un_block_code(void);

__bit which_functions_are_unblocked;

#define encoder_only 0
#define buttons_and_potentiometers_too 1
