...
//converts ema_integer to ema_alpha (int to float)
void calculate_alpha(void);

unsigned char ema_integer = 50; //alpha (integer)
//MINIMUM 10 ---> fine (more smooth)
...
typedef struct Potentiometers {
    ...
    signed char controller_number_two_byte;  // two byte controlChange number associated with the potentiometer
} potentiometer_type;
...
//initialize array of potentiometer structs (for potentiometer inputs):
    ...
    /* V2.0, V2.1 board */
        ...
        //PCB (16 potentiometers) --- JXPOT, JYPOT
        potentiometer_type inputPotsArray[NUM_ANALOG] = {POT1,POT2,POT3,POT4,POT5,POT6,POT7,SPOT1,SPOT2,SPOT3,SPOT4,SPOT5,SPOT6,SPOT7,JXPOT,JYPOT};
    #endif
