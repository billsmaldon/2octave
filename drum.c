...
void processDrumpad(void) {
    ...
    if(((drum_button_state_now) & DRUM_BUTTON_1) && !drum.SW2) {
        drum.SW2 = 1;
    ...
    if(((drum_button_state_now) & DRUM_BUTTON_2) && !drum.SW3) {
        drum.SW3 = 1;
    ...
    if(((drum_button_state_now) & DRUM_BUTTON_3) && !drum.SW4) {
        drum.SW4 = 1;
    ...
    //paste 4 code blocks here
    
    if(((drum_button_state_now) & DRUM_BUTTON_4) && !drum.SW5){
        drum.SW5 = 1;
    ...
    if(((drum_button_state_now) & DRUM_BUTTON_5) && !drum.SW6) {
        drum.SW6 = 1;
    ...
    if(((drum_button_state_now) & DRUM_BUTTON_6) && !drum.SW7) {
        drum.SW7 = 1;
    ...
    if(((drum_button_state_now) & DRUM_BUTTON_7) && !drum.SW8) {
        drum.SW8 = 1;
